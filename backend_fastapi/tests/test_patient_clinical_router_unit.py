...
@pytest.mark.parametrize(
  ("method", "path", "attr"),
  [
    ("post", "/api/patients/1/clinical/measures", "create_measure"),
    ("put", "/api/patients/1/clinical/measures/1", "update_measure"),
    ("delete", "/api/patients/1/clinical/measures/1", "delete_measure"),
    ("post", "/api/patients/1/clinical/medications", "create_medication"),
    ("put", "/api/patients/1/clinical/medications/2", "update_medication"),
    ("delete", "/api/patients/1/clinical/medications/2", "delete_medication"),
    ("post", "/api/patients/1/clinical/surgeries", "create_surgery"),
    ("put", "/api/patients/1/clinical/surgeries/3", "update_surgery"),
    ("delete", "/api/patients/1/clinical/surgeries/3", "delete_surgery"),
    ("post", "/api/patients/1/clinical/radiotherapies", "create_radiotherapy"),
    ("put", "/api/patients/1/clinical/radiotherapies/4", "update_radiotherapy"),
    ("delete", "/api/patients/1/clinical/radiotherapies/4", "delete_radiotherapy"),
    ("post", "/api/patients/1/clinical/imaging-studies", "create_imaging_study"),
    ("put", "/api/patients/1/clinical/imaging-studies/5", "update_imaging_study"),
    ("delete", "/api/patients/1/clinical/imaging-studies/5", "delete_imaging_study"),
    ("post", "/api/patients/1/clinical/primary-cancers/1/tnm-events", "create_tnm_event"),
    ("put", "/api/patients/1/clinical/primary-cancers/1/tnm-events/6", "update_tnm_event"),
    ("delete", "/api/patients/1/clinical/primary-cancers/1/tnm-events/6", "delete_tnm_event"),
    ("post", "/api/patients/1/clinical/specimens", "create_specimen"),
    ("put", "/api/patients/1/clinical/specimens/7", "update_specimen"),
    ("delete", "/api/patients/1/clinical/specimens/7", "delete_specimen"),
    ("post", "/api/patients/1/clinical/specimens/7/biomarkers", "create_biomarker"),
    ("put", "/api/patients/1/clinical/specimens/7/biomarkers/8", "update_biomarker"),
    ("delete", "/api/patients/1/clinical/specimens/7/biomarkers/8", "delete_biomarker"),
  ],
)
