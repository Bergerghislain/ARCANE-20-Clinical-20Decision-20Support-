        ...
        <div className="border-b border-border bg-card">
          <div className="mx-auto max-w-7xl px-6 py-6">
            ...
            <div className="flex items-start justify-between gap-6">
              <div>
                <h1 className="text-3xl font-bold text-primary">{mockPatientData.name}</h1>
                <div className="mt-2 flex flex-wrap gap-4 text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {new Date(mockPatientData.lastVisit).toLocaleDateString('en-US', {
                      month: 'short',
                      day: 'numeric',
                      year: 'numeric',
                    })}
        ...
        <div className="mx-auto max-w-7xl px-6 py-8">
          <Tabs value={selectedTab} onValueChange={setSelectedTab} className="space-y-6">
            ...
            <TabsContent value="overview" className="space-y-6">
              <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="rounded-lg border border-border bg-card p-6">
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    Diagnosed on{' '}
                    {new Date(mockPatientData.diagnosisDate).toLocaleDateString('en-US', {
                      month: 'long',
                      day: 'numeric',
                      year: 'numeric',
                    })}
              ...
              {/* Key Characteristics */}
              <div className="rounded-lg border border-border bg-card p-6">
                <h3 className="font-semibold text-foreground mb-4">Key Characteristics</h3>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-lg bg-primary/5 p-4">
                    <p className="text-xs font-medium text-muted-foreground">ECOG Performance Status</p>
                  ...
                  <div className="rounded-lg bg-warning/5 p-4">
                    <p className="text-xs font-medium text-muted-foreground">LDH</p>
                    <p className="mt-1 text-2xl font-bold text-warning">
                      {mockPatientData.clinicalData.ldh}
                    </p>
                  </div>
                  <div className="rounded-lg bg-success/5 p-4">
                    <p className="text-xs font-medium text-muted-foreground">Albumin</p>
            ...
            <TabsContent value="clinical" className="space-y-6">
              <div className="rounded-lg border border-border bg-card p-6">
                <h3 className="font-semibold text-foreground mb-4">Structured Clinical Data</h3>
                <div className="space-y-4">
                  <div className="grid gap-2 sm:grid-cols-2">
                    <div>
                      <p className="text-sm text-muted-foreground">Medical Record Number</p>
                      <p className="mt-1 font-medium text-foreground">{mockPatientData.mrn}</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">Condition</p>
                      <p className="mt-1 font-medium text-foreground">{mockPatientData.condition}</p>
                    </div>
                    <div>
